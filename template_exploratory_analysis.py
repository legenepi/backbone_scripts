...
sample_file = sys.argv[1] #data/gen1/UKBiobank_500K/severe_asthma/data/ukbiobank_master_app56607.sample

pd.read_csv(sample_file,sep=" ", index_col = False, header = 0)
